...
if __name__ == '__main__':
    ...
    parser.add_argument('--image_path', type=str, default='/home/deng/jihan/VIRL_internal/data/benchmark/place_centric_data/place_centric_images/ChIJ_____-Bn1moRWGI1BpiLeN8.jpg')
